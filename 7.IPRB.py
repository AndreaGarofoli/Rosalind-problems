...
print("Write down the number of homozygous dominant")
k = float(input())

print("Write down the number of heterozygous")
m = float(input())

print("Write down the number of homozygous recessive")
n = float(input())
...
t=round(float(1 - (  ((n*(n-1)) + ((m*(m-1))/4) + (n*m)) /((k+m+n)*((k+m+n)-1)))),5)
